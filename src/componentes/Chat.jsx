  ...
  return (
    ...
    <div className={`flex justify-content items-center cursor-pointer w-100 h-[85px] px-3 hover:bg-[#202d33] ${active ? "bg-[#202d33]" : ""}`}>
        ...
        <div className='flex justify-between border-t border-neutral-700 w-100 h-100 py-3 '>
            {/*Nombre y msj*/}
            <div className='flex flex-col justify-between text-white responsive'>
            ...
            <div className='flex flex-col justify-between items-end h-100 text-xs responsive'>
            
            <p className="text-emerald-500 min-w-[55px] responsive">{time}</p>

            {unreadMsgs && (
                <div className='responsive text-white bg-emerald-500 rounded-full w-[20px] h-[20px] flex justify-center items-center'>
